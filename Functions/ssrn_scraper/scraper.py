...
def getPaper(url):
    try:
        ...
        author_data = article.find_all('div', attrs = {'class' : 'authors authors-full-width'})
        authors = author_data.find_all('h2').get_text()
        ...
        try:
            ...
            pass
        results = [url, "\"{}\"".format(title), abstract, authors, date]
        return(article)
    except:
        return("oops!")
